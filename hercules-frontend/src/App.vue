<template>
  <q-layout view="hHh lpR fFf" class="bg-grey-1">
    <q-header elevated class="bg-black text-white-8" height-hint="64">
      <q-toolbar class="GNL__toolbar">
        ...
        <q-toolbar-title v-if="$q.screen.gt.xs" shrink class="row items-center no-wrap">
          <img src="./assets/logo_hercules.jpg" width="200px">
        </q-toolbar-title>

        <q-space />

        <q-input class="GNL__toolbar-input" outlined dense v-model="search" color="bg-white-7 shadow-1" placeholder="Search for topics, locations & sources">
                ...
                <div class="q-pa-md" style="width: 400px">
                  ...
                  <div class="row items-center">
                    ...
                    <div class="col-12 q-pt-lg row justify-end">
                      ...
                      <q-btn flat dense no-caps color="white-7" size="md" style="min-width: 68px;" @click="onClear" label="Clear" v-close-popup />
                    </div>
                  </div>
                </div>
              </q-menu>
        ...
        <div class="q-gutter-sm row items-center no-wrap">
          ...
          <q-btn round flat color="white-8">
            <q-avatar size="26px">
    ...
    >
      <q-scroll-area class="fit">
        <q-list padding class="text-black-8">
          <q-item class="GNL__drawer-item" v-ripple v-for="link in links1" :key="link.text" clickable @click="navigateTo(link.link)">
            <q-item-section avatar>
              <q-icon :name="link.icon" color="black"/>
            </q-item-section>
            <q-item-section>
...
export default {
  ...
  setup () {
    ...
    return {
      ...
      links1: [
        { icon: 'web', text: 'Contract Creator', link: 'home'},
        { icon: 'person', text: 'Contract Information', link: 'contract'},
        { icon: 'star_border', text: 'Contract QA', link: 'contract-questions' },
        { icon: 'search', text: 'Contract QA List', link: 'contract-question-list' }
      ],
      links2: [
